...
class grid:
    ...
    def __init__(self, xSize, ySize, deltaX, deltaY):
        ...
        self.evenGridX = { 'field': numpy.zeros( (xSize/deltaX, ySize/deltaY+1) ), 'flux': numpy.zeros( (xSize/deltaX, ySize/deltaY+1) ) }
        self.evenGridY = { 'field': numpy.zeros( (xSize/deltaX+1, ySize/deltaY) ), 'flux': numpy.zeros( (xSize/deltaX+1, ySize/deltaY) ) }
