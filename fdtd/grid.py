...
class grid:
    ...
    def __init__(self, xSize, ySize, deltaX, deltaY):
        ...
        self.evenGridX = { 'field': numpy.zeros( (xSize/deltaX, ySize/deltaY) ), 'flux': numpy.zeros( (xSize/deltaX, ySize/deltaY) ) }
        self.evenGridY = { 'field': numpy.zeros( (xSize/deltaX, ySize/deltaY) ), 'flux': numpy.zeros( (xSize/deltaX, ySize/deltaY) ) }
